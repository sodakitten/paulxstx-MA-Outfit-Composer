...
// Paulxstx MA Outfit Composer: Universal Super Switch + Mix-and-Match configuration component
...
namespace Paulxstx.LastOpOutfitPlugin
{
    ...
    [AddComponentMenu("Paulxstx Outfit/Outfit Generator")]
    ...
    public class LastOpOutfitComponent : MonoBehaviour
    {
        ...
        [Header("Build Assets")]
        [InspectorName("Build Assets目录")]
        public string outputFolder = "Assets/Paulxstx Outfit生成";

        [InspectorName("按角色名生成独立资源目录")]
        [Tooltip("开启后，实际生成目录会变成：Build Assets目录/角色名。这样不同模型重新生成时不会互相覆盖 Assets 里的动画控制器资源。")]
        public bool useAvatarNameSubFolder = true;

        [InspectorName("管理对象名称")]
        public string managerObjectName = "Paulxstx Outfit Manager";
        ...
        [Header("菜单")]
        [InspectorName("根菜单名称")]
        public string rootMenuName = "Paulxstx Outfit";
        ...
        [Tooltip("Off by default to avoid lag. Only auto-fills Mix sub-level close menus, not Super Switch toggles.")]
        ...
        [Tooltip("Only used via manual fill button. Off by default to avoid mass toggle injection.")]
        ...
        [Header("Build Assets名称")]
        [InspectorName("动画控制器资源名")]
        public string fxAnimatorAssetName = "最终操作_通用混搭_动画控制器";

        [Header("Super Switch Groups: Clothes is default. Add Hairstyle, /套装/身体等")]
